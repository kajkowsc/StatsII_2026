...
\begin{description}
	\item When a district is competitive, had an average poverty level, and a PAN governor the estimated mean is $\exp 0.015$ $\approx$ 1.015. Therefore, the chance of a PAN canidate visiting said district increases by approximately 1.5 percent. 
\end{description}	
\end{enumerate}
