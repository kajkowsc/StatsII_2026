# Replication File for Figure 3 of "The Influence of Religious-Political 
# Sophistication on U.S. Public Opinion" (Eric R. Schmidt)
# Effect of RPS and Church Attendance on Evangelical Protestant Support for 
...
evan.cath$interaction4 = evan.cath$church*evan.cath$rps.abortion
#------------
# Call up Zelig
library(Zelig)
#------------
...
ggsave(plot = our.plot, file = "Fig3.eps", height = 234, width = 177, units = "mm")
#-------------------------------------------------------------------------------
